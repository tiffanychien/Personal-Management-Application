...
export var Expenses = React.createClass({
  ...
  render: function () {
    var {id, description, value, date, onPercentage, dispatch} = this.props;
    ...
    return (
      <div className="item clearfix" id="expense-{id}">
        ...
        <div className="right clearfix">
          ...
          <div className="item__percentage">{onPercentage}%</div>
          <div className="item__delete" onClick={() => {
              dispatch(actions.DeleteExpenses(id));
              this.props.onDeleteExpense(value);
            }}>
